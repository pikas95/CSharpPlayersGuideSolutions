...
void DisplayPack()
{
    Console.WriteLine("Your Pack:");
    Console.WriteLine($"Items Stashed: {pack.ItemCount} | Items Max: {pack.ItemsMax}");
    Console.WriteLine($"Weight: {pack.Weight} | Weight Max: {pack.WeightMax}");
    Console.WriteLine($"Volume: {pack.Volume} | Volume Max: {pack.VolumeMax}");
    Console.WriteLine("-------------------------------------------------------------");
}
...
internal class Arrow : InventoryItem { public Arrow() : base(0.1f, 0.05f) { } }
internal class Bow : InventoryItem { public Bow() : base(1, 4) { } }
internal class Rope : InventoryItem { public Rope() : base(1, 1.5f) { } }
internal class Water : InventoryItem { public Water() : base(2, 3) { } }
internal class Food : InventoryItem { public Food() : base(1, 0.5f) { } }
internal class Sword : InventoryItem { public Sword() : base(5, 3) { } }